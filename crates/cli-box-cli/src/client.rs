...
pub struct DaemonSandbox {
    pub id: String,
    pub kind: cli_box_core::instance::InstanceKind,
    pub status: cli_box_core::instance::InstanceStatus,
    pub port: u16,
...
pub async fn daemon_click(sandbox_id: &str, x: f64, y: f64, button: &str) -> Result<()> {
    ...
    let client = reqwest_client();
    client
        .post(format!("{base}/box/{sandbox_id}/input/click"))
...
pub async fn daemon_type(sandbox_id: &str, text: &str) -> Result<()> {
    ...
    let client = reqwest_client();
    client
        .post(format!("{base}/box/{sandbox_id}/input/type"))
...
pub async fn daemon_key(sandbox_id: &str, key: &str, modifiers: &[String]) -> Result<()> {
    ...
    let client = reqwest_client();
    client
        .post(format!("{base}/box/{sandbox_id}/input/key"))
...
pub async fn daemon_close(sandbox_id: &str) -> Result<()> {
    ...
    let client = reqwest_client();
    client
        .post(format!("{base}/box/{sandbox_id}/close"))
        .send()
        .await
...
pub async fn daemon_processes(sandbox_id: &str) -> Result<Vec<ProcessInfo>> {
    ...
    let client = reqwest_client();
    let resp = client
        .get(format!("{base}/box/{sandbox_id}/processes"))
        .send()
        .await
...
pub async fn daemon_ui_find(
    ...
    let resp = client
        .post(format!("{base}/box/{sandbox_id}/ui/find"))
        .json(&body)
        .send()
        .await
...
pub async fn daemon_ui_value(sandbox_id: &str, element_id: &str) -> Result<serde_json::Value> {
    ...
    let resp = client
        .get(format!(
            "{base}/box/{sandbox_id}/ui/value?element_id={element_id}"
        ))
        .send()
        .await
...
pub async fn daemon_set_window_id(sandbox_id: &str, window_id: u32) -> Result<()> {
    ...
    let client = reqwest_client();
    let resp = client
        .post(format!("{base}/box/{sandbox_id}/window"))
...
impl SandboxClient {
    ...
    pub async fn sandbox_info(&self) -> Result<InfoResponse> {
        let resp = self
            .client
            .get(format!("{}/box/info", self.base_url))
            .send()
            .await
