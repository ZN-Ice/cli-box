      ...
      <div className="flex-1 relative flex flex-col overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 min-h-0 relative">
            <SandboxTerminal activePid={activePid} onReady={onSpawnReady} onWsError={onWsError} onWsClose={onWsClose} />
            {error && (
              <div
              ...
              >
                <div
                  className="mx-8 px-6 py-4 rounded-xl border max-w-lg text-center"
                  style={{
                    backgroundColor: "var(--sandbox-bg-secondary)",
                    borderColor: "var(--sandbox-error, #f7768e)",
                  }}
                >
                  <svg
